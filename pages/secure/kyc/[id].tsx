...
import {Kyc,KycService,KycKey } from '@services/Kyc';
...
const KycDetails = () => {
    ...
    useEffect(() => {
        ...
        let d=  await kycService.getKycDetails(idVal);
...
<BlockViewer header="Kyc details"  containerClassName="surface-section px-4 py-8 md:px-6 lg:px-8">
<Toast ref={toast} />
...
KycDetails.getInitialProps = (ctx:any) => {  
    const { id } = ctx.query;
