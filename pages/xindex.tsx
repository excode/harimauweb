...
const LandingPage: Page = () => {
    ...
    return (
        ...
        //                 <img src={`/layout/images/${layoutConfig.colorScheme === 'light' ? 'logo-dark' : 'logo-white'}.png`} alt="Sakai Logo" height="50" className="mr-0 lg:mr-2" />
        //                 <span className="text-900 font-medium text-2xl line-height-3 mr-8">{config.title}</span>
        //             </Link>
        ...
        //                     <Button label="Dashboard" onClick={() => router.push('/secure')} rounded className="border-none ml-5 font-light line-height-2 bg-blue-500 text-white"></Button>
        //                 </div>
        //             </div>
        //         </div>
